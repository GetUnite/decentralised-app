...
test('isNumeric function', () => {
  ...
  expect(isNumeric('0.5')).toBeTruthy();
  expect(isNumeric('-0.5')).toBeTruthy();
  expect(isNumeric('1.23e+5')).toBeTruthy();
...
test('toExactFixed function', () => {
  ...
  expect(toExactFixed('1.23e+5', 2, true)).toEqual('123000.00');

  // positive numbers without zero float ends
  expect(toExactFixed('1', 2)).toEqual('1');
  expect(toExactFixed('1.23e+5', 2)).toEqual('123000');
  ...
  //zero
  expect(toExactFixed('0', 2, true)).toEqual('0');
...
test('hasCorrectDecimals function', () => {
  ...
  expect(hasCorrectDecimals('1.23e+5', 0)).toBeTruthy();
